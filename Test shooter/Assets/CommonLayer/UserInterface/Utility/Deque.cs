...
{
    /// <summary>
    ///     A double-ended queue (deque), which provides O(1) indexed access, O(1) removals from the begin to the end, amortized
    ///     O(1) insertions to the begin and the end, and O(N) insertions and removals anywhere else (with the operations getting
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, IList
    {
        ...
        /// <summary>
        ///     Maximum cap of internal buffer array
        /// </summary>
        private const int MaximumCapacity = 2146435071;
